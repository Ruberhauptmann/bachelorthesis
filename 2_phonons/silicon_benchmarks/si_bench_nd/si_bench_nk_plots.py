...
if __name__ == "__main__":
    ...
    nd_plots.plot(walltimes, n_procs, "si_ph", "absolute", plot_error=True)
    ...
    nd_plots.plot(speedup, n_procs, "si_ph", "speedup", plot_error=True)
    ...
    nd_plots.plot(wait_time, n_procs, "si_ph", "wait")
    ...
    nd_plots.plot(efficiency, n_procs, "si_ph", "efficiency")