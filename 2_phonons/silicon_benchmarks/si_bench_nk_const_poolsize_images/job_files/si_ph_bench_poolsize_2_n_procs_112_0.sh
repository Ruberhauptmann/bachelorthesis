...
#$ -l excl=TRUE
#$ -pe mpi 112
#$ -N si_ph_bench_poolsize_2_n_procs_112_0
#$ -cwd
#$ -S /bin/bash
...
/usr/bin/time --format=%e -p mpirun $QEPREFIX/bin/ph.x -ni 4 -nk 14 -nd 9 -i in_files/si_ph_bench_poolsize_2_n_procs_112_0.ph