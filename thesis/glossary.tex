...
\newacronym{sts}{STS}{Scanning Tunneling Spectroscopy}
...
\newglossaryentry{wall_time}{
    name={wall time},
    description={Real time elapsed between the start and end time of a process}}

\newglossaryentry{cpu_time}{
    name={CPU time},
    description={Time spent by a process on the supposed purpose}}

\newglossaryentry{wait_time}{
    name={wait time},
    description={Time a process spent waiting while other processes run on the CPU}}
