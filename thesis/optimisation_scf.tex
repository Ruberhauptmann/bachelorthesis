...
\todo{analysis with right plots for ompi, ompi+openblas, maybe kick out scalapack? it should be the same}
...
\todo{absolute runtimes! so comparison is possible! (singlecore runtimes could also be differen!)}
