...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\textwidth]{plots_scf/TaS2_intel_la_parallel_bench_absolute.pdf}
    \caption{Benchmark with linear algebra parallelization for the TaS2 benchmarking system}
    \label{fig:scaling_scf_nd_tas2_absolute}
\end{figure}
