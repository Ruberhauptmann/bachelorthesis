...
\todo{formulate differently with new figure structure!}
...
\subsection{k-points parallelization}
...
This means the parallelization is as good as possible for these \todo{more analysis: difference between poolsizes}
...
\subsection{Linear Algebra Parallelisation}
