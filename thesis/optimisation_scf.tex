...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.8\textwidth]{plots_scf/si_ompi_bench_nprocs_speedup.pdf}
...
\todo{talk a bit about silicon there, then introduce TaS2}

\begin{figure}[ht!]
\centering
\includegraphics[width=0.8\textwidth]{plots_scf/TaS2_ompi_bench_nprocs_speedup.pdf}
...
Three different metrics of scalability are pictured in \ref{fig:scaling_ompi_nprocs}. \todo{formulate differently with new figure structure!}
\begin{itemize}
...
As discussed in sec. \ref{sec:qe}, for the compilation of \QE \todo{missing}
...
This means the parallelization is as good as possible for these \todo{missing}
