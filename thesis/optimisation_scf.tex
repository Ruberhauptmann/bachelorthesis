...
\caption{Scalability for the TaS2 benchmarking system, \emph{\QE 7.0, OpenMPI 4.1.0, \texttt{nk 1} and \texttt{nd 1}}}
...
\end{subfigure}
\caption{Absolute runtime and wait time for the scalability test on the TaS2 benchmarking system, \emph{\QE 7.0, \gls{openmpi} 4.1.0, \texttt{nk 1} and \texttt{nd 1}}}
...
\begin{table}[ht!]
    \caption{Selected absolute runtimes of \QE compiled with \gls{openmpi} and \gls{oneapi} for the Si benchmarking system, \emph{\texttt{nk 1} and \texttt{nd 1}}}
...
\begin{figure}[ht!]
    ...
    \caption{Scalability for the TaS2 benchmarking system, \emph{\QE 7.0 compiled with \gls{oneapi} 2021.4, \texttt{nk 1} and \texttt{nd 1}}}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{Absolute runtime and wait time for the scalability test on the TaS2 benchmarking system, \emph{\QE compiled with \gls{oneapi} 2021.4, \texttt{nk 1} and \texttt{nd 1}}}
...
\begin{figure}[ht!]
    ...
    \caption{Scalability utilizing k-point parallelization for the TaS2 benchmarking system, \emph{\QE compiled with \gls{oneapi} 2021.4, \texttt{nd 1}}}
...
\begin{figure}[ht!]
    ...
    \end{subfigure}
    \caption{Absolute runtime and wait time for the scalability test with k-point parallelization for the TaS2 benchmarking system, \emph{\QE compiled with \gls{oneapi} 2021.4, \texttt{nd 1}}}
...
\caption{Scalability and runtime utilizing linear algebra parallelization for the TaS2 benchmarking system, \emph{\QE compiled with \gls{oneapi} 2021.4, \texttt{nk} chosen such that pool size = 36}}
\end{figure}
