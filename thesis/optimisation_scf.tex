...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.75\textwidth]{plots_scf/TaS2_intel_bench_nprocs_wait.pdf}
    \caption{CAPTION}
    \label{fig:scaling_scf_intel_nprocs_tas2_wait}
\end{figure}

\todo{TaS2 intel scaling}

\todo{why choose intel? seems to work best with the infiniband hardware, huge difference for TaS2}

% So schreiben dass es für beide Systeme gilt! -> section conclusion
