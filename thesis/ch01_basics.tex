...
In reality, there are many factors either limiting or in some cases accelerating parallel code execution. Limiting factors include:
\begin{itemize}
    \item \emph{Algorithmic limitations}: some parts 
    \item \emph{Bottlenecks}:
    \item \emph{Startup Overhead}:
