...
\begin{align}
    \ope{H} &= \ope{T}_e + \ope{U}_{e-e} + \ope{T}_{n} + \ope{V}_{n-e} + \ope{W}_{n-n} \\
    &= - \sum_i \frac{1}{2} \nabla^2_i 
...
where
\begin{itemize}
    \item \(\ope{T}_e\,, \ope{T}_n\) are the kinetic energies of the electrons and nuclei respectively
    \item \(\ope{U}_{e-e}\) is the Coulomb interaction between the electrons and the nuclei
...
\begin{align}
    \ope{H}_{BO} &= \ope{T}_e + \ope{U}_{e-e} + \ope{V}_{n-e} + \ope{W}_{n-n} \\
    &= -\sum_i \frac{1}{2} \nabla^2_i 
    + \frac{1}{2} \sum_{i \neq j} \frac{1}{\vert \vb{r}_i - \vb{r}_j \vert} 
