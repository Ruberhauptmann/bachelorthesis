...
#$ -l h_vmem=3G
#$ -pe mpi 18
#$ -N TaS2_cdw_bench_ompi_poolsize_18_n_procs_18_9
#$ -l excl=TRUE
#$ -cwd
#$ -S /bin/bash
...
/usr/bin/time --format=%e -p mpirun $QEPREFIX/bin/pw.x -nd 1 -nk 1 -i in_files/TaS2_cdw_bench_ompi_poolsize_18_n_procs_18_9.scf