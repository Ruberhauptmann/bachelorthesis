...
#$ -l h_vmem=3G
#$ -pe mpi 54
#$ -N TaS2_cdw_bench_ompi_poolsize_18_n_procs_54_5
#$ -l excl=TRUE
#$ -cwd
#$ -S /bin/bash
...
/usr/bin/time --format=%e -p mpirun $QEPREFIX/bin/pw.x -nd 1 -nk 3 -i in_files/TaS2_cdw_bench_ompi_poolsize_18_n_procs_54_5.scf