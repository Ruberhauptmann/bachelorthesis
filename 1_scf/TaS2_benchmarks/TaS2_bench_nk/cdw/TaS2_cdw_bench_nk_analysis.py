...
if __name__ == "__main__":
    ...
    nk_plots.plot(cputimes, walltimes, n_procs, "TaS2_ompi", "absolute")
    ...
    nk_plots.plot(speedup_cpu, speedup_wall, n_procs, "TaS2_ompi", "speedup")
    ...
    nk_plots.plot(wait_time, wait_time, n_procs, "TaS2_ompi", "wait")
    ...
    nk_plots.plot(efficiency_cpu, efficiency_wall, n_procs, "TaS2_ompi", "efficiency")
