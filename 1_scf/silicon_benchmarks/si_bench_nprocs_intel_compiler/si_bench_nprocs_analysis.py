...
if __name__ == "__main__":
    ...
    nprocs_plots.plot(walltimes, n_procs, "si_intel", "absolute")
    ...
    nprocs_plots.plot(speedup, n_procs, "si_intel", "speedup")
    ...
    nprocs_plots.plot(efficiency, n_procs, "si_intel", "efficiency")