...
if __name__ == "__main__":
    ...
    nk_plots.plot(walltimes, n_procs, "si_intel", "absolute")
    ...
    nk_plots.plot(speedup, n_procs, "si_intel", "speedup")
    ...
    nk_plots.plot(wait_time, n_procs, "si_intel", "wait")
    ...
    nk_plots.plot(efficiency, n_procs, "si_intel", "efficiency")
