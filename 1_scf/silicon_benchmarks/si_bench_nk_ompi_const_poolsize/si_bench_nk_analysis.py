...
if __name__ == "__main__":
    ...
    nk_plots.plot(walltimes, n_procs, "small_si_ompi", "absolute", plot_error=True, figsize="small")
    ...
    nk_plots.plot(speedup, n_procs, "small_si_ompi", "speedup", plot_error=True, figsize="small")
