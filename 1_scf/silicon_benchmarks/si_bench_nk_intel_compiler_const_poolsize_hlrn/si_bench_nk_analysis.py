...
if __name__ == "__main__":
    ...
    nk_plots.plot(walltimes, n_procs, "si_hlrn", "absolute", plot_error=True)
    ...
    nk_plots.plot(speedup, n_procs, "si_hlrn", "speedup", plot_error=True)
    ...
    nk_plots.plot(efficiency, n_procs, "si_hlrn", "efficiency", plot_error=True)